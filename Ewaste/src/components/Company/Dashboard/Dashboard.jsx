...
import { FaClipboardList, FaBoxOpen, FaDatabase } from 'react-icons/fa'; // Updated Icons
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
        ...
        >
          <FaClipboardList className="w-20 h-20 text-blue-600 mb-4" />
          <h2 className="text-2xl font-semibold text-gray-800 text-center">New Orders</h2>
        </div>

        {/* Pending Orders */}
        <div
          className="flex flex-col items-center justify-center p-8 bg-white rounded-lg shadow-lg hover:shadow-xl transition duration-300 cursor-pointer transform hover:scale-105"
          onClick={() => handleNavigate('/pending-orders')}
        >
          <FaBoxOpen className="w-20 h-20 text-blue-600 mb-4" />
          <h2 className="text-2xl font-semibold text-gray-800 text-center">Pending Orders</h2>
        </div>
        ...
        >
          ...
          <h2 className="text-2xl font-semibold text-gray-800 text-center">View Database</h2>
        </div>
      </div>
    </div>
  );
